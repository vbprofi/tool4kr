...
CREATE TABLE "abo" (
  ...
  "bezahlt am" real NOT NULL,
  "bezahlt von" real NOT NULL,
  "bezahlt bis" real NOT NULL,
...
CREATE TABLE "kunden" (
  ...
  "bemerkung_id" integer NOT NULL,
  "erstellt am" real NOT NULL,
  "geändert am" real NOT NULL,
...
CREATE TABLE "status" (
  "id" integer NOT NULL PRIMARY KEY AUTOINCREMENT,
  "eintritt am" real NOT NULL,
  "austritt am" real NOT NULL,
