...
namespace KRTool.Model.migration
{
    public class MigrationInitializer : IDatabaseInitializer<DatabaseContext>
    {
        ...
        private const int _REQUIRED_VERSION = 1; //bei einem DB-Update muss diese Version manuell geändert werden
        // Default version number bei creating empty database (DEFAULT: 0)
    ...
    public void InitializeDatabase(DatabaseContext context)
        {
            ...
            if (currentVersion < _REQUIRED_VERSION)
            {
                ...
                // Check we have SQLite as database
